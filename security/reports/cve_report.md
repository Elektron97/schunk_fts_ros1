...
|-------|---------|--------|
| black | 26.5.1 | build/schunk_fts_driver/setup.py |
| certifi | 2026.6.17 | build/schunk_fts_driver/setup.py |
| charset-normalizer | 3.4.7 | build/schunk_fts_driver/setup.py |
| click | 8.4.2 | build/schunk_fts_driver/setup.py |
| exceptiongroup | 1.3.1 | build/schunk_fts_driver/setup.py |
| idna | 3.18 | build/schunk_fts_driver/setup.py |
| iniconfig | 2.3.0 | build/schunk_fts_driver/setup.py |
| lark | 1.3.1 | build/schunk_fts_driver/setup.py |
| mypy_extensions | 1.1.0 | build/schunk_fts_driver/setup.py |
| numpy | 2.2.6 | build/schunk_fts_driver/setup.py |
| packaging | 26.2 | build/schunk_fts_driver/setup.py |
| pathspec | 1.1.1 | build/schunk_fts_driver/setup.py |
| platformdirs | 4.10.0 | build/schunk_fts_driver/setup.py |
| pluggy | 1.6.0 | build/schunk_fts_driver/setup.py |
| pytest | 8.4.2 | build/schunk_fts_driver/setup.py |
| pytest-repeat | 0.9.4 | build/schunk_fts_driver/setup.py |
| PyYAML | 6.0.3 | build/schunk_fts_driver/setup.py |
| requests | 2.34.2 | build/schunk_fts_driver/setup.py |
| tomli | 2.4.1 | build/schunk_fts_driver/setup.py |
| typing_extensions | 4.15.0 | build/schunk_fts_driver/setup.py |
| urllib3 | 2.7.0 | build/schunk_fts_driver/setup.py |
| psutil | 7.2.2 | build/schunk_fts_library/setup.py |
...
| rclpy | ROS | build/schunk_fts_driver/package.xml | [ros2/rclpy](https://github.com/ros2/rclpy) |
| launch | ROS | build/schunk_fts_driver/package.xml | [ros2/launch](https://github.com/ros2/launch) |
| launch_ros | ROS | build/schunk_fts_driver/package.xml | [ros2/launch_ros](https://github.com/ros2/launch_ros) |
| geometry_msgs | ROS | build/schunk_fts_driver/package.xml | [ros2/common_interfaces](https://github.com/ros2/common_interfaces) |
| std_srvs | ROS | build/schunk_fts_driver/package.xml | [ros2/common_interfaces](https://github.com/ros2/common_interfaces) |
| sensor_msgs | ROS | build/schunk_fts_driver/package.xml | [ros2/common_interfaces](https://github.com/ros2/common_interfaces) |
| diagnostic_msgs | ROS | build/schunk_fts_driver/package.xml | [ros2/common_interfaces](https://github.com/ros2/common_interfaces) |
| example_interfaces | ROS | build/schunk_fts_driver/package.xml | [ros2/example_interfaces](https://github.com/ros2/example_interfaces) |

## Gefundene Schwachstellen

### GHSA-6w46-j5rx-g56g

- **Paket:** PyPI:pytest@8.4.2
- **CVSS-Score:** 6.8
